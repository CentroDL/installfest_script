...
```
bash <(curl -sL https://raw.githubusercontent.com/centrodl/installfest_script/magnum/builds/mac)
```
...
```
bash <(wget -qO- https://raw.githubusercontent.com/centrodl/installfest_script/magnum/builds/ubuntu)
```
