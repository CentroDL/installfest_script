...
```
bash <(curl -sL https://raw.githubusercontent.com/centrodl/installfest_script/blue_steel/builds/mac)
```
...
```
bash <(wget -qO- https://raw.githubusercontent.com/centrodl/installfest_script/blue_steel/builds/ubuntu)
```
